...
const Model = () => {
  ...
  const getCurrentTitle = () => {
    const colorDescription = model.title.split('in ')[1];
    
    if (size === 'large') {
      return `iPhone 15 Pro Max in ${colorDescription}`;
    } else {
      return `iPhone 15 Pro in ${colorDescription}`;
    }
  };
      ...
      <div className="screen-max-width">
        ...
        <div className="flex flex-col items-center mt-5">
          ...
          <div className="mx-auto w-full">
            <p className="text-sm font-light text-center mb-5">{getCurrentTitle()}</p>
